...
use mem_core::{join_confidence, ContentHash, Edge, EdgeKind, EdgeMethod, MemoryNode, Plane};
...
// MEM-B-002 node join, shared with `mem_assert::apply_diff` (PBA-L6b-002).
use mem_assert::join::{merge_node, status_rank, trust_conservatism};
